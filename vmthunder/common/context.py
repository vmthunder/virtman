...
"""RequestContext: context for requests that persist through all of vmthunder."""

import copy
import uuid

from vmthunder.openstack.common import local
from vmthunder.openstack.common import log as logging
from vmthunder.openstack.common import timeutils
from vmthunder import policy
...
class RequestContext(object):
    ...
    # tenant/user whereas the vmthunder version uses project_id/user_id. We need
