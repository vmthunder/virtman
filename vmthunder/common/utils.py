...
def find_config(config_path):
    ...
    :raises: `vmthunder.exception.ConfigNotFound`
    ...
    def create(self):
        try:
            ...
            if self.password:
                ...
                raise exception.VMThunderException(msg)
...
def vmthunderdir():
    import vmthunder
    return os.path.abspath(vmthunder.__file__).split('vmthunder/__init__.py')[0]
...
def monkey_patch():
    ...
    Example: 'vmthunder.api.ec2.cloud:' \
     vmthunder.openstack.common.notifier.api.notify_decorator'

    Parameters of the decorator is as follows.
    (See vmthunder.openstack.common.notifier.api.notify_decorator)
...
def get_root_helper():
    return 'sudo vmthunder-rootwrap %s' % CONF.rootwrap_config


def brick_get_connector_properties():
    """wrapper for the brick calls to automatically set
    the root_helper needed for vmthunder.
    """
