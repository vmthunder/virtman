...
class Server(object):
    ...
    def __init__(self, name, loader=None, host=None, port=None, pool_size=None,
        ...
        self.name = name
        self.loader = loader or  Loader('/root/VMThunder/VMThunder/bin/api-paste.ini')
    ...
    def start(self, backlog=128):
        ...
        :returns: None
        :raises: vmthunder.exception.InvalidInput
...
class Application(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = vmthunder.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import vmthunder.api.fancy_api
...
class Middleware(Application):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = vmthunder.api.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import vmthunder.api.analytics
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `vmthunder.exception.PasteAppNotFound`
