...
* Call set_defaults with the minimal of the following kwargs:
  ...
  Example:
    ...
    session.set_defaults(
        sql_connection="sqlite:///var/lib/vmthunder/sqlite.db",
        sqlite_db="/var/lib/vmthunder/sqlite.db")
...
from vmthunder.openstack.common.db import exception
    ...
    def _do_query(self, q):
        ...
        for file, line, method, function in traceback.extract_stack():
            ...
            if file.endswith('db/api.py'):
                continue
            # only trace inside vmthunder
            index = file.rfind('vmthunder')
            if index == -1:
                continue
