...
from vmthunder.openstack.common import fileutils
from vmthunder.openstack.common.gettextutils import _, _LE, _LI
...
util_opts = [
    ...
    cfg.StrOpt('lock_path',
               default=os.environ.get("VMTHUNDER_LOCK_PATH"),
...
def main(argv):
    ...
    os.environ["VMTHUNDER_LOCK_PATH"] = lock_dir
    try:
