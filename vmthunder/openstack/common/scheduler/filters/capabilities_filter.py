...
from vmthunder.openstack.common.gettextutils import _  # noqa
from vmthunder.openstack.common import log as logging
from vmthunder.openstack.common.scheduler import filters
from vmthunder.openstack.common.scheduler.filters import extra_specs_ops
...
class CapabilitiesFilter(filters.BaseHostFilter):
    ...
    def host_passes(self, host_state, filter_properties):
        ...
        # Note(zhiteng) Currently only vmthunder and Nova are using
